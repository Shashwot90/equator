      ...
      <section class="section-padding">
        <div class="container">
            <div class="gallery-view">
                <div class="row" id="lightgallery" lg-uid="lg0">
                        <div class="item col-md-4" data-src="/uploads/banner_image/1684661940_1680086571_1679979980_popup3.png" data-sub-html="<h4>Newsbanner three</h4>">
                        <a href="/#">
